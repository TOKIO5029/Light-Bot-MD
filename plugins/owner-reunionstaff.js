let handler = async(m, { conn, command, text }) => {
  ...
  if ( users == 34610246115 || users == 5492612721386 || users == 5493834258985 || users == 50558124470) try {
...
*Staff 𝙡𝙞𝙜𝙝𝙩 𝙔𝙖𝙜𝙖𝙢𝙞 𝙗𝙤𝙩* [✨]`
m.reply('[🍨]𝗣𝗲𝗿𝗳𝗲𝗰𝘁𝗼, 𝘀𝗲 𝗲𝘀𝘁𝗮 𝗲𝗻𝘃𝗶𝗮𝗻𝗱𝗼 𝗲𝗹 𝗺𝗲𝗻𝘀𝗮𝗷𝗲 𝗮 𝗹𝗼𝘀 𝗼𝘄𝗻𝗲𝗿𝘀(𝗦𝘁𝗮𝗳𝗳) *𝙡𝙞𝙜𝙝𝙩 𝙔𝙖𝙜𝙖𝙢𝙞 𝙗𝙤𝙩*')
