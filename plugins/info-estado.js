...
┃⍣ *ꨄ︎ ⌨︎ 𝘖𝘸𝘯𝘦𝘳: 🐉𝙉𝙚𝙤𝙏𝙤𝙠𝙮𝙤 𝘽𝙚𝙖𝙩𝙨🐲*
┃⍣ *ꨄ︎ ➪ 𝘊𝘶𝘦𝘯𝘵𝘢𝘴 𝘖𝘧𝘤:* https://chat.whatsapp.com/DmaLM7iLSFKKi7RkqUkv71
╰✧ » ◇ « ✧ » ✦ « ✧ » ◇ « ✧`.trim();
        const doc = [
    "pdf",
    "zip",
...
const document = doc[Math.floor(Math.random() * doc.length)];
  const Message = {
    document: { url: `https://chat.whatsapp.com/DmaLM7iLSFKKi7RkqUkv71` },
    mimetype: `application/${document}`,
    fileName: `「 𝙡𝙞𝙜𝙝𝙩 𝙔𝙖𝙜𝙖𝙢𝙞 𝙗𝙤𝙩」`,
...
showAdAttribution: !![],
        ...
        sourceUrl: "https://chat.whatsapp.com/DmaLM7iLSFKKi7RkqUkv71",
      },
    },
    caption: str,
    footer: wm,
