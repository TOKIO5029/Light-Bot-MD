...
## 🌸`light yagami`🌸
## ⭐ **`light yagami la directora de "el camino" ahora en tu WhatsApp**
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&pause=1000&color=FF0000&lines=Bienvenid@+a+mi+repositorio;disfruta+de+light🦋+❤️‍🔥yajuuu🔥)](https://git.io/typing-svg)
![light](https://i.pinimg.com/originals/19/80/6e/19806e91932e6054965fc83b85241270.gif)
...
[![Click Aquí](https://img.shields.io/badge/Grupo-Sumi-25D366?style=for-the-badge&logo=whatsapp&logoColor=white)](https://chat.whatsapp.com/D9hmosKv0924sPqyXeu1CU)
...
```
```bash
git clone https://github.com/TOKIO5029/Light-Bot-MD && cd Light-Bot-MD
```
```bash
...
> ESCRIBE LOS SIGUIENTES COMANDOS UNO POR UNO:
> cd loght
> rm -rf Light-Bot-MD-session
> npm start
```

🍟 **`light-yagami 24/7 (TERMUX)`**
```bash
> termux-wake-lock && npm i -g pm2 && pm2 start index.js && pm2 save && pm2 logs 
```

💥 **`ACTUALIZAR Sumi`**
> Note Comandos para actualizar light-yagami de forma automática
```bash
...
### **`❤️‍🔥 PROPIETARIO`**
<a 
href="https://github.com/TOKIO5029"><img src="https://github.com/TOKIO5029.png" width="130" height="130" alt="leonel"/></a>

### **`💻 STAFF ZAHPKIEL`**
<a 
href="https://github.com/EnderJs-CreatorGL"><img src="https://github.com/EnderJs-CreatorGL.png" width="130" height="130" alt="leonel"/></a>
